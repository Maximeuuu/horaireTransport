...
public class HorairesTransport
{
	...
	ATTRIBUTS
	*/
	public final static String REPERTOIRE ="horaires/";
	...
	*/
	public HorairesTransport( String fichier )
	{
		...
		this.tabDonneesOrig = HorairesTransport.chargerDonnees( fichier );
	...
	public static String[] getListeFichier()
	{
	...
	//charge les données depuis un fichier de ligne de transport
	private static Object[][] chargerDonnees( String fichier )
	{
...
// TODO : mettre un try catch pour les heures ?
		/*Analyse des heures*/
		try
		{
